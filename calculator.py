...
Substraction=Button(cal, padx=19, pady=16, bd=8, fg="black", font=('arial', 20, 'bold'), text="-", bg="powder blue", command=lambda:btnClick("-")).grid(row=2, column=3)
#============================================================================================================================================================>
...
Multiply=Button(cal, padx=16, pady=16, bd=8, fg="black", font=('arial', 20, 'bold'), text="x", bg="powder blue", command=lambda:btnClick("*")).grid(row=3, column=3)
#============================================================================================================================================================>
...
btnClear=Button(cal, padx=104, pady=16, bd=8, fg="black", font=('arial', 20, 'bold'), text="C", bg="powder blue", command= btnClearDisplay).grid(row=5, column=0 , columnspan=3)
...
btnKoma=Button(cal, padx=19, pady=16, bd=8, fg="black", font=('arial', 20, 'bold'), text=",", bg="powder blue", command=lambda:btnClick(",")).grid(row=4, column=0)


Division=Button(cal, padx=16, pady=65, bd=8, fg="black", font=('arial', 20, 'bold'), text="÷", bg="powder blue", command=lambda:btnClick("/")).grid(row=4, rowspan=2 , column=3)
